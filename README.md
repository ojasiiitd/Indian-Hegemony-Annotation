...
- [Cultural Hegemony Annotation Portal](#cultural-hegemony-annotation-portal)
  ...
  - [Setup](#setup)
    ...
    - [2. Set Up Credentials](#2-set-up-credentials)
      - [`accounts/google_creds.json`](#accountsgoogle_credsjson)
      - [`accounts/apikeys.json`](#accountsapikeysjson)
    - [3. Configure the Application](#3-configure-the-application)
      - [Region → State Map](#region--state-map)
      - [Google Sheet](#google-sheet)
      - [Hegemony Axes](#hegemony-axes)
      - [Headers](#headers)
      - [Onboarded Annotators](#onboarded-annotators)
  ...
  - [API Endpoints](#api-endpoints)
    ...
    - [Admin](#admin)
    - [Inter-Annotator Review](#inter-annotator-review)
    - [Notes \& Similarity](#notes--similarity)
